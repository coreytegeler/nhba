...
(function() {
  window.initPublic = function() {
    var $body, $buildingTiles, $buildings, $filterSect, $glossarySect, $grid, $gridWrap, $infoSect, $main, $searchSect, $side, $singleSect, buildingMapSetup, centerGrid, clearFilter, clickBuilding, clickFilter, clickMarker, clickToggle, clickTour, closeSide, filter, filterIsOn, filterQuery, filterUrl, getContent, getParam, getParams, grid, hoverBuilding, infoMapSetup, makeDraggable, mobile, nextSlide, openSide, paginate, popState, resizeGrid, search, selectBuilding, setUp, setUpSlider, tourMapSetup, unhoverBuilding, updateSingleSect, urlQuery;
    $body = $('body');
    $main = $('main');
    $side = $('aside');
    $gridWrap = $('.gridWrap');
